...
* __chisel__ ([https://github.com/ucb-bar/chisel](https://github.com/ucb-bar/chisel)):
  ...
  external dependency.
* **rocket** ([https://github.com/ucb-bar/rocket](https://github.com/ucb-bar/rocket)):
...
* __RocketChip.scala__: Top-level source file (Top is the top-level
...
* __Host-target interface (HostIO)__: The host system talks to the
...
###  1) Using the high-performance cycle-accurate C++ emulator
...
###  2) Mapping a Rocket core down to an FPGA
